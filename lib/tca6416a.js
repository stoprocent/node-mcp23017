...
var TCA6416A = (function() {
  ...
  TCA6416A.prototype.gpioAState = 0x0; //initial state of GPIOS A
  TCA6416A.prototype.gpioBState = 0x0; //initial state of GPIOS B
  ...
  */
  ...
  TCA6416A.prototype._send = function (cmd, values) {
    this.wire.writeByte(this.address, cmd, values[0], function (error) {
      if (error) {
        console.error(error);
      }
    });
